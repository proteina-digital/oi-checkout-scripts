<!-- GERAL -->
<!--[if lte IE 9]><script src="//cdnjs.cloudflare.com/ajax/libs/placeholders/3.0.2/placeholders.min.js"></script><![endif]--><script src="https://cdn.jsdelivr.net/npm/jquery-mask-plugin@1.14.16/dist/jquery.mask.min.js"></script>
<script>
  // FIND POLYFILL
...
function api_infos(response) {
    let type_viability = response.hasOwnProperty('type_viability') && response.type_viability !== null && response.type_viability !== undefined && response.type_viability !== "" ? response.type_viability : 'CEP_V1';
    
    let value_stream = response.hasOwnProperty('value_stream') && response.value_stream !== null && response.value_stream !== undefined && response.value_stream !== "" ? response.value_stream : 'BRONZE';
